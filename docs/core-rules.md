...
To control the base, the attacking player must start their turn with at least 1 unit in the opponent's base and no opposing units.
...
| [Romans](factions/romans.md) |
| [Vandals](factions/vandals.md) |
| [Vikings](factions/vikings.md) |
